...
export default function Profil() {
	...
	function setFollow() {
		...
		httpClient
			.post(`users/${id}/${current_user.user_id}`, {
				mode: isFollowed ? 'remove' : 'add',
			})
			...
			<div className="uk-flex" id="user_profil" data-uk-grid>
				<div className="uk-width-medium uk-margin-medium-left avatar uk-logo">
					<Thumbnail
						src={
							user.profile_pic
								? HttpClient.imageUrl(user.profile_pic)
				...
				<div className="uk-flex uk-flex-bottom uk-flex uk-flex-1 uk-margin-large-bottom counters">
					<span className="uk-margin-right">
						<i className="far fa-thumbs-up uk-margin-small-right"></i>
						{user.Likes}
					</span>
					<span className="uk-margin-right">
				...
				{isLogin && (
					<div className="icons uk-margin-medium-right uk-flex uk-flex-middle">
						{user.donation_link && (
							<a
								target="_blank"
								rel="noreferrer"
								className="icons_clickable"
								href={`https://paypal.me/${user.donation_link}`}
							>
						...
						{!isOwnPage && (
							<button
								className="uk-button uk-button-link icons_clickable"
								key={isFollowed ? 'minus' : 'plus'}
								onClick={() => setFollow()}
						...
						<a className="icons_clickable" href={`mailto:${user.mail}`}>
							<i className="fas fa-envelope uk-margin-right"></i>
						</a>
						<div>
							{isOwnPage && (
								<div>
						...
						<div data-uk-dropdown="mode:click">
							<ul className="uk-nav uk-dropdown-nav">
								<li>
									<a
										href="#change_information"
										uk-toggle="target: #change_information"
									>
										Change information
									</a>
								</li>
								...
								<li>
									<a
										...
										uk-toggle="target: #change_password"
									>
										Change the password
									</a>
								</li>
								<ChangePassword />
								<li>
									<a href="#change_picture" uk-toggle="target: #change_picture">
